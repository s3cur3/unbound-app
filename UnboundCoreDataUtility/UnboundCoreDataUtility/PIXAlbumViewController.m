...
{
    PIXPhotoStreamWindowController *browserWindow = nil;
    if (browserWindow == nil) {
        ...
        browserWindow.browserData = [anAlbum.photos mutableCopy];
    }
    [PIXAppDelegate sharedAppDelegate]->browserWindow = browserWindow;
    [browserWindow showWindow:[PIXAppDelegate sharedAppDelegate]];
