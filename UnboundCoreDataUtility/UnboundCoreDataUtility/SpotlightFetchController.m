...
-(void)fetchAllPhotos
{
    NSURL *url = [NSURL fileURLWithPath:@"/Users/inzan/Dropbox/Photos"];
    ...
    [_query setPredicate:imagesPredicate];
...
- (void)sendQueryDidFinishNote {
    [[NSNotificationCenter defaultCenter] postNotificationName:SearchDidFinishNotification object:self userInfo:@{@"items" : _children}];
}
...
- (id)metadataQuery:(NSMetadataQuery *)query replacementObjectForResultObject:(NSMetadataItem *)result {
    ...
    //return result;//[[Photo alloc] initWithMetadataItem:result];
    NSString *albumPath = [result valueForAttribute:(NSString *)kMDItemPath];
    return @{@"path" : albumPath, @"dirPath" : [albumPath stringByDeletingLastPathComponent]};
}
