...
//    if (!startedObserving)
//    {
//        [[NSNotificationCenter defaultCenter] addObserverForName:SearchDidFinishNotification object:nil queue:[NSOperationQueue mainQueue] usingBlock:^(NSNotification *note) {
//
//            NSLog(@"Finished loading photos");
//            [self photosFinishedLoading:note];
//            
//        }];
//        startedObserving = YES;
//    }
}
...
//    
//    [imageContent removeAllObjects];
//    NSArray *newItems = [note.userInfo valueForKey:@"items"];
//    NSString *aPath = nil;
//    //NSURL *anImageURL = nil;
//    NSImage *anImage = nil;
//    for (NSDictionary *anItem in newItems)
//    {
//        aPath = [anItem valueForKey:@"path"];
//        //anImageURL = [NSURL fileURLWithPath:aPath isDirectory:NO];
//        anImage = [[NSImage alloc] initByReferencingFile:aPath];
//        [imageContent addObject:anImage];
//    }
//    [self.collectionView reloadDataWithItems:imageContent emptyCaches:YES];
//    [[NSNotificationCenter defaultCenter] removeObserver:self name:SearchDidFinishNotification object:nil];
//}
